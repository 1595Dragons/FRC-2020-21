...
public class RobotMap {
	...
	public double drive_kp=.0001, drive_ki=.000002, drive_kd=.000001, drive_kiz=500, drive_kff=.000175;
	...
	/*this.shooter1=new CANSparkMax(shooter1ID, MotorType.kBrushless);
		...
		*/
		...
		setUpPIDController(rightdrive_pidController,drive_kp,drive_ki,drive_kd,drive_kiz,drive_kff,1,-1);
		setUpPIDController(leftdrive_pidController,drive_kp,drive_ki,drive_kd,drive_kiz,drive_kff,1,-1);
